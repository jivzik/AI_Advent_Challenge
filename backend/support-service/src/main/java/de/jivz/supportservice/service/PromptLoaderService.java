...
public class PromptLoaderService {
    ...
    @Value("classpath:prompts/support-assistant.md")
    private Resource supportAssistantPrompt;
    ...
    private void loadPrompts() {
        try {
            ...
            promptCache.put("support-assistant", loadResource(supportAssistantPrompt));
